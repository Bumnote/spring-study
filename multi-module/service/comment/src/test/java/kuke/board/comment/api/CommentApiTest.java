...
class CommentApiTest {
  ...
  void read() {
    CommentResponse response = restClient.get()
        .uri("/v1/comments/{commentId}", 264418497518919680L)
        .retrieve()
        .body(CommentResponse.class);
  ...
  @Test
  void delete() {
    //  commentId: 264418497518919680
    //   |-  commentId: 264418498001264640
    //   |-  commentId: 264418498064179200
    restClient.delete()
        .uri("/v1/comments/{commentId}", 264418498064179200L)
        .retrieve();
  }
